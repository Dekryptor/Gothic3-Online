...
template< class T >
void bTObjArray< T >::InsertAt( int _i, T const & _e )
{
    int const _c = this->GetCount();
    if( _c == _i )
    {
        this->Add( _e );
    }
...
template< typename T >
T & bTObjArray< T >::InsertNewAt( int _i )
{
    int const _c = this->GetCount();
    if( _c == _i )
    {
...
template< typename T >
void bTObjArray< T >::RemoveAt( int _i )
{
    int const _u = this->GetCount() - 1;
    if( (0 <= _i) && (_i <= _u) )
    {
...
template< typename T >
void bTObjArray< T >::Reserve( int _n )
{
...
template< typename T >
void bTObjArray< T >::SetAt( int _i, T const & _e )
{
...
template< typename T >
void bTObjArray< T >::SetCount( int _n )
{
    if( 0 == _n )
        this->Clear();
    else
...
template< typename T >
bTObjArray< T >::bTObjArray( int _n ) :
    bTArrayBase< T >()
{
    this->Reserve( _n );
}
