...
class UserDataHandler extends DataHandler
{
	...
	*/
	function verify_password()
	{
		...
		// MD5 the password
		$user['md5password'] = $user['password'];//md5($user['password']);

		// Generate our salt
		$user['salt'] = "NULL";//$user['salt'] = generate_salt();

		// Combine the password and salt
		$user['saltedpw'] = $user['password'];//salt_password($user['md5password'], $user['salt']);
