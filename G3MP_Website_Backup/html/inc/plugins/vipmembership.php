	...
	if($run_module == 'user' && $action_file == 'vipmembership')
	{
		...
		elseif ($mybb->input['action'] == 'expired')
		{
			...
			while ($mem = $db->fetch_array($query))
			{
				...
				// actions column
				$table->construct_cell("<a href=\"index.php?module=user-vipmembership&amp;action=enduser&amp;mid=".intval($member['mid'])."\">".$lang->vipmembership_end."</a> - <a href=\"index.php?module=user-vipmembership&amp;action=edituser&amp;mid=".intval($member['mid'])."\">".$lang->vipmembership_edit."</a> - <a href=\"index.php?module=user-vipmembership&amp;action=deleteuser&amp;mid=".intval($member['mid'])."\">".$lang->vipmembership_delete."</a>", array('class' => 'align_center'));
